...
- **age・annual_income は顧客に聞かない**: これらは引き継ぎコンテキスト（`customer_context`）に含まれている。`recommend.py` の引数に必要な場合はコンテキストから取得して渡すこと
  - 例: `{"customer_id": "C016", "age": 31, "annual_income": 5500000}`
